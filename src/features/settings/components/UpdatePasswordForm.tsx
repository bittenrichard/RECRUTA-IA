...
const UpdatePasswordForm = () => {
    ...
    const handlePasswordSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            // No Baserow, "mudar a senha" é simplesmente atualizar o campo 'senha_hash'
            await baserow.patch(USERS_TABLE_ID, profile.id, {
                senha_hash: password, // ATENÇÃO: Provisório. Não é seguro para produção.
            });
